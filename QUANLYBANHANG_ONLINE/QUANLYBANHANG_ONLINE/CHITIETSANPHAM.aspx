<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.Master" AutoEventWireup="true" CodeBehind="CHITIETSANPHAM.aspx.cs" Inherits="QUANLYBANHANG_ONLINE.CHITIETSANPHAM" ValidateRequest="false" EnableEventValidation="false" %>
...
border="0" width="100px" height="100px" /></a></div> 
                ...
                Eval("DONGIA") %></span></div>
                 ...
                 <div class="prod_details_tab"> 
                  <asp:ImageButton title="header=[Add to cart] body[&nbsp;] fade=[on]" ID="Imagecart" runat="server"  ImageUrl="images/cart.gif"
                      class="left_bt" OnClick="Imagecart_Click" />
